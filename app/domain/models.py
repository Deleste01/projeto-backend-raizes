...
CANAIS_PEDIDO = ('APP', 'TOTEM', 'BALCAO', 'PICKUP', 'WEB')
STATUS_PEDIDO = (
...
class Pedido(db.Model):
    ...
    canal_pedido = db.Column(db.Enum(*CANAIS_PEDIDO, name='canais_enum'), nullable=False)
    status = db.Column(db.Enum(*STATUS_PEDIDO, name='status_enum'), default='AGUARDANDO_PAGAMENTO')
